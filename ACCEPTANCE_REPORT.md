...
> 最新版本 1.3.4 的验收见 [2026-09-16 验收报告](review/2026-09-16/ACCEPTANCE.md)。1.3.3 的修复记录见 [2026-09-13 验收报告](review/2026-09-13/ACCEPTANCE.md)。以下保留 1.3.2 的历史验收记录。

日期：2026-09-07。基于提交 `20a6c172a0e7d6ca29d44c357ddd1835761d8f6c` 的修复，更新说明位于 `CHANGELOG.md` 的 `1.3.2` 条目。原始修复验收记录保留不变，版本发布前的复验见 [release-1.3.2.json](review/2026-09-07/release-1.3.2.json)。
